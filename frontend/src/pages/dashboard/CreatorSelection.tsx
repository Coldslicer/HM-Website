...
export const CreatorSelection: React.FC<CreatorSelectionProps> = ({
  campaignId,
}) => {
  ...
  if (currentCampaign?.status === "draft") {
    return (
      <div className="max-w-screen-xl mx-auto p-4 bg-gray-50 rounded-md">
        ...
        <div className="text-black">
          After submitting your brief, here's where you'll see creators who want
          to work with you!
        </div>
      </div>
    );
    ...
    return (
      <div className="max-w-screen-xl mx-auto p-4 bg-gray-50 rounded-md">
        ...
        <div className="text-black">
          You'll see creators here as they express interest to participate.
          Please check back later to give creators time to view your brief! We
          typically get responses within a day.
        </div>
      </div>
    );
  }
            ...
            {creators.map((creator) => (
              ...
              >
                <td className="py-3 px-4">
                  {creator.channel_name || creator.channelTitle || ""}
                </td>
                <td className="py-3 px-4">
                  <a
