    ...
    return (
      <div className="max-w-screen-xl mx-auto p-4 bg-gray-50 rounded-md">
        ...
        <p className="text-black">
          This feature is not currently available to you<br />
  ...
  useEffect(() => {
    const fetchCampaignData = async () => {
      ...
      if (data) {
        ...
        setSelectedOption(data.fully_managed ? 'fully_managed' : 'self_service');
      }
    };
  ...
  return (
    <div className="max-w-screen-xl mx-auto p-4 bg-gray-100 rounded-md">
      ...
      <form onSubmit={handleSubmit} className="mb-6">
        ...
        {/* Additional Options */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-black mb-2">Additional Options</h3>
          <div className="bg-white p-4 rounded-md shadow-md">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              />
              <div>
                <h4 className="text-lg font-medium text-black">Fully Managed Service</h4>
                <p className="text-gray-600 text-sm">Our team will handle all aspects of the campaign for you.</p>
              </div>
            </label>
            ...
            <label className="flex items-start space-x-3 cursor-pointer mt-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">You will manage the campaign on your own with our platform.</p>
              </div>
            </label>
          </div>
        </div>
      ...
      {responseData ? (
        ...
        <div className="bg-gray-200 h-[500px] max-h-[80vh] flex items-center justify-center border rounded-md shadow-md">
          <p className="text-gray-600 text-lg">Please submit your email to proceed with the contract.</p>
        </div>
      )}
    </div>
  );
