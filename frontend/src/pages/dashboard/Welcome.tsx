  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">
            Step 2 (Optional): Talk with the CEO
          </h2>
...
.invert-calcom *:not(img):not(video):not(iframe) {
  ...
  `}
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">
            Step 4: Fill Out Your Campaign Brief
          </h2>
          <p>
            Enter your brand information, creator preferences, and your creative
            brief.
          </p>
          <NavLink
            to="/dashboard/brief"
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2">
            Step 5: You're Ready to See Creators!
          </h2>
          <p>
            Now that your brief is complete, you can explore potential creators
            for your campaign.
          </p>
        </div>
      </div>
